...
public class EventsCommittee extends AppCompatActivity {
    Snackbar snackbar;
    WebView webView ;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (WebView) findViewById(R.id.EEB3Web);
        ...
        webView.loadUrl("https://ec.eeb3.eu/");
    }
    ...
    private class MyWebViewClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (!isNetworkAvailable()) {
                ...
                EventsCommittee.this.setValue(newProgress);
