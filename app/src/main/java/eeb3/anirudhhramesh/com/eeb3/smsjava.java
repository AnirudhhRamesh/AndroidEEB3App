...
public class smsjava extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        webView = (WebView) findViewById(R.id.SMSWeb);


        webView.setWebViewClient(new smsjava.MyBrowser());
        webView.getSettings().setDomStorageEnabled(true);
        webView.getSettings().setAppCacheMaxSize(5 * 1024 * 1024); // 5MB
        webView.getSettings().setAppCachePath(getApplicationContext().getCacheDir().getAbsolutePath());
        webView.getSettings().setAllowFileAccess(true);
        webView.setWebChromeClient(new smsjava.MyWebViewClient());
    ...
    private class MyWebViewClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (!isNetworkAvailable()) {
                ...
                smsjava.this.setValue(newProgress);
    ...
    public void donate(){
        AlertDialog.Builder builder = new AlertDialog.Builder(smsjava.this);
        ...
        builder.setPositiveButton("Set Password", new DialogInterface.OnClickListener() {
            ...
            {
                Intent i = new Intent(smsjava.this, SMSCredentialsActivity.class);
                startActivity(i);
            }
        });
