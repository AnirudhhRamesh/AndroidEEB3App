...
public class ixlweeklyweb extends ActionBarActivity {
    Snackbar snackbar;
    WebView webView ;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ixlweeklyweb);
        ...
        webView.loadUrl("http://thexlweekly.tumblr.com/");
    }
    ...
    private class MyWebViewClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (!isNetworkAvailable()) {
                ...
                ixlweeklyweb.this.setValue(newProgress);
