...
public class eebgreenweb extends ActionBarActivity {
    Snackbar snackbar;
    WebView webView ;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.eebgreenweb);
        ...
        webView.loadUrl("http://www.eeb3cde.eu/eebgreen.html");
    }
    ...
    private class MyWebViewClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (!isNetworkAvailable()) {
                ...
                eebgreenweb.this.setValue(newProgress);
