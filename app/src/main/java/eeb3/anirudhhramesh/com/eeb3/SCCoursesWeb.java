...
public class SCCoursesWeb extends ActionBarActivity {
    Snackbar snackbar;
    WebView webView;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sccourseswebctivity);
        ...
        webView.loadUrl("https://www.eventbrite.com/o/eeb3-student-courses-14302578092");
    }
    ...
    private class MyWebViewClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (!isNetworkAvailable()) {
                ...
                SCCoursesWeb.this.setValue(newProgress);
