...
public class tedxhomepage extends ActionBarActivity {
    Snackbar snackbar;
    WebView webView ;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tedxhomepage);
        ...
        webView.loadUrl("https://ec.eeb3.eu/tedx/");
    }
    ...
    private class MyWebViewClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (!isNetworkAvailable()) {
                ...
                tedxhomepage.this.setValue(newProgress);
