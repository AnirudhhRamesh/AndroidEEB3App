...
public class tedxwordpress extends ActionBarActivity {
    Snackbar snackbar;
    WebView webView ;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.tedxwordpress);
        ...
        webView.loadUrl("https://ec.eeb3.eu/tedx/volunteer");
    }
    ...
    private class MyWebViewClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (!isNetworkAvailable()) {
                ...
                tedxwordpress.this.setValue(newProgress);
