...
public class shortfilmfestweb extends ActionBarActivity {
    Snackbar snackbar;
    WebView webView ;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.shortfilmfestwordpressweb);
        ...
        webView.loadUrl("https://eeb3filmfest.wordpress.com");
    }
    ...
    private class MyWebViewClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (!isNetworkAvailable()) {
                ...
                shortfilmfestweb.this.setValue(newProgress);
