...
public class SCTeachersWeb extends ActionBarActivity {
    Snackbar snackbar;
    WebView webView;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scteacherswebactivity);
        ...
        webView.loadUrl("http://eeb3studentcourses.weebly.com/teachers.html");
    }
    ...
    private class MyWebViewClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (!isNetworkAvailable()) {
                ...
                SCTeachersWeb.this.setValue(newProgress);
