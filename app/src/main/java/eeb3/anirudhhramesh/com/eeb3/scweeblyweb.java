...
public class scweeblyweb extends ActionBarActivity {
    Snackbar snackbar;
    WebView webView ;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.scweeblyweb);
        ...
        webView.loadUrl("https://eeb3studentcourses.weebly.com");
    }
    ...
    private class MyWebViewClient extends WebChromeClient {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            if (!isNetworkAvailable()) {
                ...
                scweeblyweb.this.setValue(newProgress);
