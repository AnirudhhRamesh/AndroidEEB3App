...
public class CountDownTimer_code extends AppCompatActivity implements View.OnClickListener {
    ...
    private void startCountDownTimer() {
        ...
        countDownTimer = new CountDownTimer(timeCountInMilliSeconds, 1000) {
            ...
            public void onFinish() {
                ...
                mp = MediaPlayer.create(CountDownTimer_code.this, R.raw.alarmclocksound);
                mp.start();
